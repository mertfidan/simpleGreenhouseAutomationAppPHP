...
<form action="veriguncelle.php" method="POST">
<table border="0">
...
<p><font face="tahoma" size="3" color="yellow">(ID'yi yazmadan güncelleme yapamazsınız.Eğer ID'yi bilmiyorsanız kayitlara bakınız.)</font>
<hr>
<b>Genel Bilgiler</b>
<br>
<br>
<tr>
<td><p><font face="tahoma" size="3" color="yellow">Sera adı :</td>
...
<td><input type="submit" name="buton" value="Guncelle">
<input type="submit" name="buton" value="Kayıtlar"></td>
</form>
</body>
